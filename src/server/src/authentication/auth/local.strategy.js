...
var LocalStrategy = /** @class */ (function (_super) {
    ...
    function LocalStrategy(userRepository) {
        var _this = _super.call(this, { usernameField: 'email', passwordField: 'password' }) || this;
    ...
    LocalStrategy.prototype.validate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ relations: ['roles'], where: { email: email } })];
                    case 1:
                        user = _a.sent();
                        if (user && user.validatePassword(password))
                            return [2 /*return*/, user];
                        else
                            throw new common_1.UnauthorizedException("Wrong login details.");
                        return [2 /*return*/];
                }
            });
        });
